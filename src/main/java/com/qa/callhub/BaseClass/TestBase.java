package com.qa.callhub.BaseClass;
...
import com.qa.callhub.Utilities.WebEventListener;
...
public class TestBase
{
	...
	public TestBase() //Constructor to read data from property file.
	{
		...
		try 
		{
			...
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/qa/callhub/Configuration/Configuration.properties");
			property.load(ip);
		} 
